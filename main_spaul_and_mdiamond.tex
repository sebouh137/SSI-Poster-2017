...
\begin{figure}
\begin{center}
\includegraphics[width=0.30\textwidth]{dm_self_interaction}\hspace{1cm}
\includegraphics[width=0.5\textwidth]{dm_coannihilation}
...
\begin{figure}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=.9\textwidth]{trident_wab}
		\end{center}
